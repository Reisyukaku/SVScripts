...
class ColorUtil {
    ...
    @:native("S5DAE7E26E061D35C") static var Red:Array<Float> = [1., 0.625, 0.5, 1.];
    @:native("S9C6AA0D46D9470FC") static var Green:Array<Float> = [0.625, 1., 0.5, 1.];
    @:native("SCC12CAEF2344CFE9") static var Yellow:Array<Float> = [1., 1., 0.5, 1.];
}